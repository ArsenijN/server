        ...
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-36f6cd59
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            ...
            // 'fluxdrop-v-36f6cd59' name only works if this exact script.js
            // was built with the matching cache version.  When an old script.js
            // runs after a deploy its cached v-36f6cd59 is stale and it would
