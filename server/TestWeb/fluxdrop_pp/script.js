        ...
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-5fd63d78
...
const SCRIPT_VERSION_RAW = 'v-5fd63d78'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            const cache = await caches.open('fluxdrop-v-5fd63d78'); // replaced by build.sh — do not edit manually
