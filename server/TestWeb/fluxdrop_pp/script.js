// ======================================================================
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-68d375c4
...
const SCRIPT_VERSION_RAW = 'v-68d375c4'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            const cache = await caches.open('fluxdrop-v-68d375c4'); // replaced by build.sh — do not edit manually
