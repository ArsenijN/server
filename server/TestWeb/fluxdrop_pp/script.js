        ...
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-9de0e104
...
const SCRIPT_VERSION_RAW = 'v-9de0e104'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            ...
            const cache = await caches.open('fluxdrop-v-9de0e104'); // replaced by build.sh — do not edit manually
