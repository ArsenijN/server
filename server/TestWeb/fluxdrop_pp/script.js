// ======================================================================
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-236b68ea
...
const SCRIPT_VERSION_RAW = 'v-236b68ea'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            const cache = await caches.open('fluxdrop-v-236b68ea'); // replaced by build.sh — do not edit manually
