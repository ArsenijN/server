...
LOG_FILE = '/home/arsen/servers/self-host/site/Web/logsV2.txt' # Log file for HTTPS server
BLACKLIST_FILE = '/home/arsen/servers/self-host/site/Web/blklst.txt'
HTTPS_PORT = 1000
CERT_FILE = '/home/arsen/servers/self-host/site/Web/myCA.pem'
KEY_FILE = '/home/arsen/servers/self-host/site/Web/myCA.key'
    ...
    def do_GET(self):
        ...
        with blacklist_lock:
            if client_ip in current_blacklist:
                ...
                # Send a 403 Forbidden error response with a custom explanation
...
if __name__ == "__main__":
    ...
    httpd = http.server.HTTPServer((SERVER_IP, HTTPS_PORT), RequestHandler)

    # --- SSL Context Setup ---
    # Create an SSL context using the TLS server protocol
    ...
    try:
        ...
        sys.exit(1) # Exit on other SSL loading errors
    ...
    try:
        ...
        sys.exit(1) # Exit if SSL wrapping fails
