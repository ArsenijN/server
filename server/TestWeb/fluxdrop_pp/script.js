        ...
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-ef31d0cb
...
const SCRIPT_VERSION_RAW = 'v-ef31d0cb'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            const cache = await caches.open('fluxdrop-v-ef31d0cb'); // replaced by build.sh — do not edit manually
