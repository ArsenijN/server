        ...
        // --- DEBUG ---
        // ======================================================================
// Current version of script.js is: fluxdrop-v-13b94256
...
const SCRIPT_VERSION_RAW = 'v-13b94256'; // Replaced by your build script
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(async () => {
        ...
        try {
            const cache = await caches.open('fluxdrop-v-13b94256'); // replaced by build.sh — do not edit manually
